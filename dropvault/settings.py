"""
Django settings for dropvaluet project.
...
SECRET_KEY = "django-insecure-30r12&y3fbvnimiaf*^h0%%bzofara^0*t@lqtv=yqp5ly1&n8"
...
WSGI_APPLICATION = "dropvaluet.wsgi.application"
